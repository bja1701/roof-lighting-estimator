...
import { Link, Copy, Check, ArrowRight, Loader2, CheckCircle2, CreditCard } from 'lucide-react';
      ...
      <div className="space-y-3">
        ...
        {!job.stripe_deposit_link ? (
          <div className="flex flex-wrap items-end gap-3">
            ...
            >
              {generating ? <Loader2 size={16} className="animate-spin" /> : <Link size={16} />}
          ...
          >
            ...
            >
              {copied === 'deposit' ? <Check size={14} style={{ color: 'var(--color-success)' }} /> : <Copy size={14} />}
          ...
          {!job.stripe_final_link ? (
            ...
            >
              ...
              <button
                ...
                onMouseLeave={e => (e.currentTarget.style.color = 'var(--color-slate)')}
              >
                {copied === 'final' ? <Check size={14} style={{ color: 'var(--color-success)' }} /> : <Copy size={14} />}
