						...
						<div className="flex flex-col gap-1">
							...
							>
								...
								<input
									...
									value={pricePerFt}
									onChange={(e) =>
										setPricePerFt(parseFloat(e.target.value) || 0)
									}
						...
						<tbody className="text-xs">
							{lines.map((line) => {
								...
								const multiplier =
									line.type === 'eave'
										? 1.0
										: getMultiplierFromPitch(line.pitch);
								...
								return (
									...
									>
										<td className="p-3">
											<div
												className="font-medium capitalize truncate w-20"
				...
				>
					<div className="flex justify-between items-center text-xs">
						...
						>
							$
							{(
								estimatedCost - (includeController ? controllerFee : 0)
							).toLocaleString()}
						</span>
					</div>
					{includeController && (
