    ...
    >
      ...
      >
        <div className="p-8 md:p-12 text-center">
          ...
          <p className="font-semibold text-lg mb-6" style={{ color: 'var(--color-primary)' }}>
            You've got 5 free estimates to start.
          </p>

          <p className="leading-relaxed text-sm px-2 mb-6" style={{ color: 'var(--color-slate)' }}>
          ...
          <div className="flex justify-center gap-4 mb-10">
            <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest" style={{ color: 'var(--color-slate)' }}>
              <Satellite size={14} />
              Satellite Mapping
            </div>
            <div className="w-1 h-1 rounded-full self-center" style={{ background: 'var(--color-border)' }} />
            <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest" style={{ color: 'var(--color-slate)' }}>
              <FileText size={14} />
              Pro Proposals
            </div>
          ...
          <p className="text-xs mt-4" style={{ color: 'var(--color-slate)' }}>
            ...
            <button
              onClick={() => { void handleClose(); openUpgrade(); }}
