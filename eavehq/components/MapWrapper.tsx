		...
		return (
			...
			>
				<div
					...
					style={{
						border: '1px solid rgba(217,111,10,0.3)',
		...
		return (
			...
			>
				...
				>
					...
					<div
						className="p-3 rounded text-left mb-4"
						style={{ background: 'rgba(15,25,40,0.72)' }}
					>
						<p
					...
					<p className="text-sm" style={{ color: 'rgba(255,255,255,0.56)' }}>
						This usually means the API key is invalid, or the "Maps JavaScript
						API" is not enabled in your Google Cloud Console.
					</p>
				</div>
			</div>
		);
			...
			>
				<div className="flex flex-col items-center gap-4">
					<div
						...
						style={{
							borderColor: 'rgba(217,111,10,0.3)',
