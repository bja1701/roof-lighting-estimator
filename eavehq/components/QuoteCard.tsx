      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
            <button
              ...
              title={estimatorLocked ? 'Free estimate limit reached (5/5). Upgrade to edit.' : 'Edit in estimator'}
              className="p-2 rounded-lg transition-colors"
              style={{ color: 'var(--color-slate)' }}
              onMouseEnter={e => { if (!estimatorLocked) { e.currentTarget.style.color = 'var(--color-primary)'; e.currentTarget.style.background = 'var(--color-surface)'; } }}
            ...
            <button
              ...
              className="p-2 rounded-lg transition-colors"
              style={{ color: 'var(--color-slate)' }}
              onMouseEnter={e => { e.currentTarget.style.color = 'var(--color-destructive)'; e.currentTarget.style.background = 'rgba(201,64,64,0.06)'; }}
              onMouseLeave={e => { e.currentTarget.style.color = 'var(--color-slate)'; e.currentTarget.style.background = 'transparent'; }}
            >
              <Trash2 size={15} />
            </button>
        ...
        <div className="mb-4">
          {discountEditing ? (
            ...
            >
              <p className="text-[10px] font-bold uppercase tracking-wider" style={{ color: 'var(--color-slate)' }}>
                Discount
              </p>
                    ...
                    <button
                      ...
                      style={
                        discountType === t
                          ...
                          : { color: 'var(--color-slate)', background: 'transparent' }
                      }
                    >
                      {t === 'percent' ? '%' : '$'}
                    </button>
              ...
              {discountError && (
                <p className="text-xs" style={{ color: 'var(--color-destructive)' }}>{discountError}</p>
              )}
        ...
        >
          <div>
            <p className="text-[10px] uppercase tracking-widest font-bold" style={{ color: 'var(--color-slate)' }}>
              Total Footage
            </p>
            <p
