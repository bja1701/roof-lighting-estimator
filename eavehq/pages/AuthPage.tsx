					...
					<Card>
						<div className="px-8 py-8">
							...
							<p
								...
								style={{ color: 'rgba(255,255,255,0.4)' }}
							>
								Click the link in that email to choose a new password. Check
					...
					<div className="flex flex-col items-center mb-8">
						<div
							...
							style={{
								...
								boxShadow: '0 8px 24px rgba(58,99,73,0.4)',
								border: '1px solid rgba(255,255,255,0.15)',
							}}
						>
					...
					<Card>
						<div className="px-8 py-8">
							...
							<p
								...
								style={{ color: 'rgba(255,255,255,0.4)' }}
							>
								Click the link in that email to activate your account. If this
								email is already registered, use Sign In or reset your password
								instead.
							</p>
							<button
								type="button"
	...
	return (
		<AuthShell>
			...
			<div className="absolute inset-0 pointer-events-none overflow-hidden hidden md:block">
				<div
					className="absolute top-10 right-10 w-64 h-64 border-t border-r"
					style={{ borderColor: 'rgba(255,255,255,0.04)' }}
				/>
				<div
					className="absolute bottom-10 left-10 w-96 h-96 border-b border-l"
					style={{ borderColor: 'rgba(255,255,255,0.04)' }}
				/>
			</div>
			...
			<div className="relative z-10 w-full max-w-lg">
						...
						<form onSubmit={handleSubmit} className="space-y-5">
							...
							{tab === 'signup' && (
								<div
									...
									style={{
										background: 'rgba(58,99,73,0.25)',
										border: '1px solid rgba(58,99,73,0.4)',
									}}
								>
									<p
				...
				<p
					className="mt-8 text-center text-[11px] font-medium max-w-xs mx-auto"
