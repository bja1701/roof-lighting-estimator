...
export default function SettingsPage() {
	...
	const handleLogoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
		...
		if (file.size > LOGO_MAX_BYTES) {
			setError(
				`That file is ${(file.size / (1024 * 1024)).toFixed(1)} MB. Logos must be at most ${formatMaxLogoMb()} MB.`
			);
			setUploading(false);
			e.target.value = '';
			return;
	...
	return (
		<>
			<SharedLayout>
				...
				>
					<div className="mb-10">
						...
						>
							Manage your company branding, pricing defaults, and account
							details.
						</p>
					</div>
					...
					<div className="space-y-6">
						...
						<Section
							...
							subtitle="Shown on all PDF exports and proposals"
						>
							<div className="mb-6">
						...
						<Section
							...
							subtitle="Applied to all new estimates. Override per-estimate in the toolbar."
						>
									...
									<div className="flex items-center gap-3">
										...
										>
											...
											<input
												...
												value={pricePerFoot}
												onChange={(e) =>
													setPricePerFoot(parseFloat(e.target.value) || 0)
												}
									...
									<div className="flex items-center gap-3">
										...
										>
											...
											<input
												...
												value={controllerFee}
												onChange={(e) =>
													setControllerFee(parseFloat(e.target.value) || 0)
												}
												className="w-28 bg-transparent px-3 py-3 text-sm focus:outline-none"
												style={{
													color: 'var(--color-ink)',
						...
						<Section
							...
							subtitle="Automatically remind clients who haven't responded to their estimate."
						>
							<div className="space-y-5">
								<div>
									<label style={labelStyle}>
										Send follow-up after X days of no response
									</label>
									<div className="flex items-center gap-3">
										<input
											type="number"
											...
											value={followupDays}
											onChange={(e) =>
												setFollowupDays(parseInt(e.target.value, 10) || 1)
											}
								...
								<div>
									...
									<select
										value={followupMax}
										onChange={(e) =>
											setFollowupMax(parseInt(e.target.value, 10))
										}
						...
						<Section
							...
							title="Payments"
							subtitle="Receive client deposits directly into your account"
						>
							{connectToast && (
								<div
								...
								<div className="flex items-center justify-between">
									<div>
										...
										<p
											...
											style={{ color: 'var(--color-slate)' }}
										>
											You're set up to accept payments. Clients pay directly to
											your account.
										</p>
									</div>
									<a
								...
								<div className="flex items-center justify-between">
									<div>
										...
										<p
											...
											style={{ color: 'var(--color-slate)' }}
										>
											Connect your Stripe account to receive deposits and final
											payments directly from clients.
										</p>
									</div>
									<AccentButton
										onClick={() => void handleConnectStripe()}
								...
								<>
									<div className="flex items-center justify-between">
										<div>
											...
											>
												...
												{profile?.subscription_status === 'canceling' &&
													'Cancels at end of billing period · still have full access'}
												{!hasProAccess(profile) &&
											...
											{upgradeSuccess &&
												...
												profile?.subscription_status !== 'canceling' && (
													<p
														...
														style={{ color: 'var(--color-slate)' }}
													>
														If your plan doesn't appear active within a minute,
														contact support.
													</p>
												)}
										</div>
										<div className="flex flex-col items-end gap-2">
											{!hasProAccess(profile) ? (
												<AccentButton onClick={openUpgrade}>
													Upgrade Plan
												</AccentButton>
											) : (
												<>
									...
									{cancelConfirm && (
										...
										>
											...
											<p
												...
												style={{ color: 'var(--color-slate)' }}
											>
												You'll keep Pro access until the end of your current
												billing period. After that, you'll be limited to 5
												estimates.
											</p>
						...
						<div className="flex items-center gap-4 pt-2">
							<button
								...
								style={{
									...
									boxShadow: saving
										? 'none'
										: '0 4px 14px rgba(217,111,10,0.3)',
								}}
							>
			...
			{showProModal && (
				<ProWelcomeModal onClose={() => setShowProModal(false)} />
			)}
		</>
	);
}
