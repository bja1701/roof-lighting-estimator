          ...
          <div className="px-8 py-8">
            {done ? (
              <div className="text-center py-4">
                ...
                <p className="text-sm" style={{ color: 'rgba(255,255,255,0.5)' }}>Redirecting you to the app…</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input id="new-password" type="password" required minLength={6} value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••••" style={inputStyle} />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    <Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2" style={{ color: 'rgba(255,255,255,0.35)' }} />
                    <input id="confirm-password" type="password" required minLength={6} value={confirm} onChange={e => setConfirm(e.target.value)} placeholder="••••••••" style={inputStyle} />
                  </div>
                </div>
                {error && (
                  <div
                ...
                <button
                  ...
                  style={{
                    background: submitting ? 'rgba(255,255,255,0.1)' : 'var(--color-accent)',
                    color: submitting ? 'rgba(255,255,255,0.4)' : '#fff',
                    cursor: submitting ? 'not-allowed' : 'pointer',
                    fontFamily: 'var(--font-display)',
                    boxShadow: submitting ? 'none' : '0 4px 14px rgba(217,111,10,0.4)',
                  }}
                >
