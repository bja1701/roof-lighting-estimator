...
const FOUNDERS_PAYMENT_LINK = import.meta.env.VITE_FOUNDERS_PAYMENT_LINK as
	| string
	| undefined;
			...
			<section className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-5xl flex-col justify-center">
				<div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
					<div>
						...
						>
							The field-service command center for roofline lighting
							contractors.
						</h1>
						<p
						...
						>
							EaveHQ helps permanent lighting contractors quote faster, collect
							deposits, and keep every job moving without duct-taping together
							maps, PDFs, invoices, and notes.
						</p>
					...
					>
						<div className="mb-6 flex items-center gap-3">
							...
							<div>
								...
								<p className="text-sm" style={{ color: 'var(--color-slate)' }}>
									Fast enough for the truck cab, polished enough for the
									homeowner.
								</p>
							</div>
						</div>
						...
						{!hasPaymentLink && (
							...
							>
								...
								<span style={{ fontFamily: 'var(--font-mono)' }}>
									VITE_FOUNDERS_PAYMENT_LINK
								</span>{' '}
								after the Stripe live migration to enable checkout.
							</p>
						)}
					</aside>
				</div>
