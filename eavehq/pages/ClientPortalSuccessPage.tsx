		...
		>
			<div className="max-w-sm w-full text-center space-y-5">
					...
					>
						{contractor?.company_name ? (
							<>
								...
								will be in touch shortly to schedule your installation.
							</>
						) : (
				...
				<p className="text-xs" style={{ color: 'var(--color-border)' }}>
					You'll receive a confirmation email from Stripe. Keep it for your
					records.
				</p>

				<p className="text-xs" style={{ color: 'var(--color-border)' }}>
					Powered by <span style={{ color: 'var(--color-primary)' }}>Eave</span>
